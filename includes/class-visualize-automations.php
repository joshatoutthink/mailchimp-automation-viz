...
class Visualize_Automations {
  ...
  private function load_dependencies(){
    include_once( plugin_dir_path(dirname( __FILE__) ) . './MailChimp.php' );
    ...
    include_once(plugin_dir_path(dirname( __FILE__) ) . 'includes/pages/visualizer/visual-admin-page.php');
  }
}
