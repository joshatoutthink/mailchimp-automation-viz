...
function create_automations_page(){
  ...
  ob_start();
  ?>
  <div id="va-widget" class="app" data-state='list'>
    ...
    foreach($automations as $automation){
      ...
      <li class="automation-list-item" data-status= <?php echo '"'. $status .'"';?> >
    ...
    ?>
    </ul><!-- end of automation list -->
    
    <ul class="automation-viewer">
      <?php 
        foreach($automations as $automation){
          $name = $automation['settings']['title'];
          $id = $automation['id'];
      ...
      <li class="automation" data-status= <?php echo '"'. $status .'"';?>  data-automationview="emails">
        ...
        </ul><!-- end of automation stats -->  
      </li><!-- end of automation -->
        <?php
        }
        ?>  
    </ul><!-- endo of automation viewer -->  
